...
if (!isset($_SESSION['username']) || $_SESSION['role'] !== 'branchmanager') {
    ...
    $query_teamcount = "SELECT COUNT(DISTINCT id) AS teamcount FROM users WHERE role='sales' AND branchmanager='$bmname'";
    $result_teamcount = mysqli_query($conn, $query_teamcount);
    $row_teamcount = mysqli_fetch_assoc($result_teamcount);
    $teamcount = $row_teamcount['teamcount'];

    $query_borrowers = "SELECT COUNT(DISTINCT ID) AS borrowers FROM personalinformation where LeadStatus!='Hot Lead'";
    ...
    $query_Hot = "SELECT COUNT(DISTINCT ID) AS Hot FROM personalinformation where LeadStatus='Hot Lead' AND StepReached<>'Disbursed' AND LoanStatus<>'Rejected'";
...
WHERE 
    ...
    $query_notifications = "SELECT * FROM notifications WHERE status = 'unread' ORDER BY created_at DESC";
    ...
    // Update notification status to 'read' if the close button is clicked
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-3">
                                            ...
                                            <a href="salesteambmdashboard.php" style="text-decoration: none; color: inherit;">
                                                <span class="counter-value" data-target="1256"><?php echo $teamcount; ?></span>
                                            </a>
                                        </h4>
                                    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-3">
                                            ...
                                            <a href="leadsales.php" style="text-decoration: none; color: inherit;">
                            ...
                            <div class="card-body" style="background: #c9e7db;">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-3">
                                            <a href="hot_leads.php" style="text-decoration: none; color: inherit;">
