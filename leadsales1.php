...
<body>
    ...
    <div class="container" style="margin-left:90px;">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Leads Classification</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="form-group">
            <input type="text" id="searchInput" class="form-control" placeholder="Search by Name or Lead ID">
        </div>
        <!-- Table -->
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody id="leadsTableBody">
                    ...
                    if ($loggedInUser) {
                        ...
                        echo "<tr><td colspan='11'>You are not authorized to view this data</td></tr>";
                    }
