            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        ...
                        <a href="dashboardrecovery.php" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="assets/images/logo-sm.svg" alt="" height="30">
                            </span>
                            <span class="logo-lg">
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="assigned_recoveries.php">
                          
                                <i data-feather="users"></i>
                                <span data-key="t-chat">Assigned Recoveries</span>
                            </a>
                        </li>
                        
                         <li>
                            <a href="followups_recovery.php">
                           
                                <i data-feather="users"></i>
                                <span data-key="t-chat">Followups</span>
                            </a>
                        </li>
                        
                         <li>
                            <a href="visitneeded.php">
                          
                                <i data-feather="users"></i>
                                <span data-key="t-chat">Visit's Needed</span>
                            </a>
                        </li>
                        
                               <li>
                            <a href="recovery_legal_cases.php">
                            
                                <i data-feather="users"></i>
                                <span data-key="t-chat">Legal Cases</span>
                            </a>
                        </li>
