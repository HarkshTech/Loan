...
<body>
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Disbursal's Done Today !</li>
                                        </ol>
                                    </div>
    ...
    <h1>Disbursal's Approved Today</h1>
    <table>
        <thead>
            <tr>
                <th>LeadID</th>
        ...
        <tbody>
           ...
           <?php
            ...
            $query_all_details = "SELECT * FROM emi_schedule where DATE(datestarted) = CURDATE();";
