    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="salesteambmdashboard.php">Welcome !</a></li>
                ...
                <div class="row">
                    <?php
                    $colors = ['#8EC6C5', '#A1D6E2', '#F0B7A4', '#F7CAC9', '#D5E1DF', '#B8A9C9', '#EAD7D1'];
                        ...
                        while ($row = $result_users->fetch_assoc()) {
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card card-h-100">
                                    <!-- card body -->
                                    <div class="card-body" style="background: <?php echo htmlspecialchars($color); ?>;">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate"><?php echo htmlspecialchars($username); ?></span>
                                                <h4 class="mb-3">
                                                    <a href="salesbm.php?username=<?php echo urlencode($username); ?>" style="text-decoration: none; color: inherit;">
