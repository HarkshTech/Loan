    ...
    <script>
        $(document).ready(function() {
            $('#search-input').on('keyup', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'saleshotleads.php', // Replace with the actual file name if different
...
<body>
    ...
    <div class="search-container">
        <input type="text" id="search-input" placeholder="Search by ID, name, amount, or purpose...">
    </div>
