...
<head>
    ...
    <style>
        .table-container {
            width: 100%;
            /* Full width or set a specific width */
            height: 80vh;
...
<body>
    <div class="container">
        ...
        <form method="get" action="">
            <input type="text" name="search" value="<?= htmlspecialchars($search); ?>" placeholder="Search by LeadID or Verifier Name">
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <button data-bs-toggle="modal" data-bs-target="#statusModalApplicant<?= $row['leadID']; ?>">Update Status (Applicant)</button>
                            ...
                            <td>
                                <button data-bs-toggle="modal" data-bs-target="#statusModalCOAPP<?= $row['leadID']; ?>">Update Status (CO-Applicant)</button>
