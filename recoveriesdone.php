...
<head>
    ...
    <title>Records with Case Status "Recovery Done"</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<h2 class='my-4'>Recovery Done Cases</h2>";
            ...
            echo "<p class='mt-4'>No records found with Case Status 'Recovery Done'</p>";
        }
