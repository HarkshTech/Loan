...
<head>
    ...
    <title>Closed Loans Details</title>
    <style>
        body {
...
<body>
    ...
    <table>
        ...
        <tbody>
            <?php
            // Include the database connection file again for table content
            include 'config.php';

            // Fetch all columns from the personalinformation table
            $query_all_details = "SELECT * FROM personalinformation WHERE LoanStatus='Closed'";
